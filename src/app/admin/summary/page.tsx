        ...
        <>
          ...
          >
            <div style={{ padding: '16px 20px', backgroundColor: '#f8f9fa', borderBottom: '1px solid #e9ecef' }}>
              ...
              <div style={{ marginTop: 6, color: '#6c757d', fontSize: '0.85rem' }}>
                集計範囲: 日本時間（JST）{String(stats?.news_fetch_runs_since_acq_change?.since_jst ?? '2026-01-11 11:00')} 〜 現在
              </div>
              <div style={{ marginTop: 6, color: '#6c757d', fontSize: '0.85rem' }}>
                表記:{' '}
          ...
          {/* 取得設定変更後（2026-01-11 11:00 JST以降）の country×category（sources / new_topics / summarized_ready_topics） */}
          <section
            style={{
              marginBottom: 32,
              backgroundColor: '#fff',
          ...
          >
            <div style={{ padding: '16px 20px', backgroundColor: '#f8f9fa', borderBottom: '1px solid #e9ecef' }}>
              ...
              <div style={{ marginTop: 6, color: '#6c757d', fontSize: '0.9rem' }}>
                集計範囲: 日本時間（JST）{String(stats?.topic_metrics_by_country_category_since_acq_change?.since_jst ?? '2026-01-11 11:00')} 〜 現在
              </div>
              <div style={{ marginTop: 6, color: '#6c757d', fontSize: '0.85rem' }}>
